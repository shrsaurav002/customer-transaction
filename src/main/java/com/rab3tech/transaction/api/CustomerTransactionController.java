...
import com.rab3tech.transaction.api.dto.CustomerVO;

@RestController
@RequestMapping("/customer")
public class CustomerTransactionController {
@Value("${banking.application.name}")
private String hostname;
	...
	public List<CustomerVO> findAllCustomer() {
		// File file = new
		// File("F:/workspace/customer-transaction-api/src/main/resources/bank_keystore.p12");
		...
		ResponseEntity<? extends List> result = restTemplate.exchange(hostname+"/v4/customers",
				HttpMethod.GET, entity, customerVOs.getClass());
